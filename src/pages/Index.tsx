...
const content = {
  ...
  pt: {
    ...
    projects: "Projetos",
    language: "Idioma",
    devopsTitle: "Desenvolvedor DevOps",
  ...
  es: {
    ...
    projects: "Proyectos",
    language: "Idioma",
    devopsTitle: "Desarrollador DevOps",
  ...
  fr: {
    ...
    projects: "Projets",
    language: "Langue",
    devopsTitle: "Développeur DevOps",
